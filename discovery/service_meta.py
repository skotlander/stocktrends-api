...
SERVICE_EVALUATION_GUIDANCE = (
    ...
    "GET /v1/stocktrends/portfolios), and what it costs "
...
SERVICE_EVALUATION_GUIDANCE_SUMMARY = (
    ...
    "(/v1/selections/stim-select/outcomes/summary, /v1/stocktrends/portfolios), and "
    "cost (/v1/pricing/catalog, /v1/cost-estimate). "
