...
def ai_tools():
    ...
    return {
        ...
        "notes": [
            ...
            "For x402, inspect the 402 stocktrends_preview before paying; it is the final pre-payment surface for a request that is already serviceable, not an input-schema reference.",
