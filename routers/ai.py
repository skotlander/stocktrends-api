...
def ai_tools():
    ...
    return {
        ...
        "notes": [
            ...
            "For x402, inspect the 402 stocktrends_preview before paying; it is the final pre-payment surface, not an input-schema reference — confirm the request is serviceable from /v1/ai/tools or /v1/openapi.json first.",
